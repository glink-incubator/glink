 ...
 * @author Xu Qi
 */
public class SimpleSTDTPointFlatMapper extends RichFlatMapFunction<String, Tuple2<Point, String>> {
  private static final Logger LOGGER = LoggerFactory.getLogger(SimpleSTDTPointFlatMapper.class);
  ...
  @Override
  public void flatMap(String line, Collector<Tuple2<Point, String>> collector) throws Exception {
    try {
      ...
      collector.collect(new Tuple2<>(p, id));
    } catch (Exception e) {
